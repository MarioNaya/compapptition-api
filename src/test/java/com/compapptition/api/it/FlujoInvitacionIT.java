package com.compapptition.api.it;

import com.compapptition.api.dto.auth.AuthResponse;
import com.compapptition.api.dto.auth.LoginRequest;
import com.compapptition.api.dto.auth.RegistroRequest;
import com.compapptition.api.entity.Competicion;
import com.compapptition.api.entity.Deporte;
...
import com.compapptition.api.util.BaseIntegrationTest;
...
class FlujoInvitacionIT extends BaseIntegrationTest {
    ...
    void setUp() {
        ...
        com.compapptition.api.entity.Usuario emisor = usuarioRepository.findById(emisorId).orElseThrow();
        urcRepository.save(com.compapptition.api.entity.UsuarioRolCompeticion.builder()
